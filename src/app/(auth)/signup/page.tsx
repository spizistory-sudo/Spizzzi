      ...
      <div className="w-full max-w-md glass" style={{ padding: '40px 36px', borderRadius: 'var(--radius-lg)' }}>
        ...
        <form onSubmit={handleSignup} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          <div>
            ...
            <input
              id="fullName" type="text" value={fullName} onChange={(e) => setFullName(e.target.value)} required dir="auto"
              className="input-field" style={{ width: '100%' }} placeholder="השם שלכם"
            />
          </div>
          ...
          <div>
            ...
            <input
              id="email" type="email" value={email} onChange={(e) => setEmail(e.target.value)} required dir="ltr"
          ...
          <div>
            ...
            <input
              id="password" type="password" value={password} onChange={(e) => setPassword(e.target.value)} required minLength={6} dir="ltr"
              className="input-field" style={{ width: '100%' }} placeholder="לפחות 6 תווים"
            />
          </div>
        ...
        <div style={{ margin: '24px 0' }}>
          <div style={{ position: 'relative', display: 'flex', alignItems: 'center' }}>
            ...
            <span style={{ padding: '0 12px', color: 'var(--text-faint)', fontSize: '0.82rem', fontFamily: 'var(--font-body)' }}>או</span>
            <div style={{ flex: 1, borderTop: '1px solid rgba(255,255,255,0.10)' }} />
          </div>
        </div>
        ...
        >
          ...
          <span dir="ltr">Google</span> המשיכו עם
        </button>
